...
#import "_TCXNextSport.h"

#import "TCXActivityLap.h"
#import "TCXActivity.h"


@implementation _TCXNextSport 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"transition;Transition;object(TCXActivityLap)"];
    
    [mappings bmSafeAddObject:@"activity;Activity;object(TCXActivity)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"transition", self.transition];
    
    [s appendFormat:@", %@: %@", @"activity", self.activity];
