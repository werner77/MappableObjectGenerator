...
#import "_TCXCustomHeartRateZone.h"

#import "TCXHeartRateValue.h"
#import "TCXHeartRateValue.h"


@implementation _TCXCustomHeartRateZone 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"low;Low;object(TCXHeartRateValue)"];
    
    [mappings bmSafeAddObject:@"high;High;object(TCXHeartRateValue)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"low", self.low];
    
    [s appendFormat:@", %@: %@", @"high", self.high];
