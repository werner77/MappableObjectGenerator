...
#import "_TCXHeartRateAbove.h"

#import "TCXHeartRateValue.h"


@implementation _TCXHeartRateAbove 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"heartRate;HeartRate;object(TCXHeartRateValue)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"heartRate", self.heartRate];
