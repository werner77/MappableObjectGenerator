...
#import "_TCXPosition.h"

#import "TCXDegreesLatitude.h"
#import "TCXDegreesLongitude.h"


@implementation _TCXPosition 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"latitudeDegrees;LatitudeDegrees;object(TCXDegreesLatitude)"];
    
    [mappings bmSafeAddObject:@"longitudeDegrees;LongitudeDegrees;object(TCXDegreesLongitude)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"latitudeDegrees", self.latitudeDegrees];
    
    [s appendFormat:@", %@: %@", @"longitudeDegrees", self.longitudeDegrees];
