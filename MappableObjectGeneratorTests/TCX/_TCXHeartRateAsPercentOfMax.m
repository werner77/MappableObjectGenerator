...
#import "_TCXHeartRateAsPercentOfMax.h"

#import "TCXPercentOfMax.h"


@implementation _TCXHeartRateAsPercentOfMax 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"value;Value;object(TCXPercentOfMax)"];
