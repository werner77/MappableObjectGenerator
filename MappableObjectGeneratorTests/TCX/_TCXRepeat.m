...
#import "TCXRepetitions.h"
#import "TCXAbstractStep.h"


@implementation _TCXRepeat 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"repetitions;Repetitions;object(TCXRepetitions)"];
    
    [mappings bmSafeAddObject:@"childs;Child;array(TCXAbstractStep)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"repetitions", self.repetitions];
    
    [s appendFormat:@", %@: %@", @"childs", self.childs];
