...
- (void)setEnumValue:(TCXGenderValue)theValue {
...
- (BOOL)isEqual:(id)other {
    ...
    _TCXGender *otherValue = (_TCXGender *)other;
...
+ (id)instanceWithEnumValue:(TCXGenderValue)theValue {
    _TCXGender * instance = [[self alloc] init];
