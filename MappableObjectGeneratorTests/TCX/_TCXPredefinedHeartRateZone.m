...
#import "_TCXPredefinedHeartRateZone.h"

#import "TCXHeartRateZoneNumbers.h"


@implementation _TCXPredefinedHeartRateZone 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"number;Number;object(TCXHeartRateZoneNumbers)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"number", self.number];
