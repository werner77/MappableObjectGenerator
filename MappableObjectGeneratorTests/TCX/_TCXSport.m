...
+ (void)initialize {
	if (!valueMapping) {
		...
		@"Running", @(TCXSportRunning),
		@"Biking", @(TCXSportBiking),
		@"Other", @(TCXSportOther),
...
- (void)setEnumValue:(TCXSportValue)theValue {
...
- (BOOL)isEqual:(id)other {
    ...
    _TCXSport *otherValue = (_TCXSport *)other;
...
+ (id)instanceWithEnumValue:(TCXSportValue)theValue {
    _TCXSport * instance = [[self alloc] init];
