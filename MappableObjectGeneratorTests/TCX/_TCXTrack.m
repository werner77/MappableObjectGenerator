...
#import "TCXTrackpoint.h"


@implementation _TCXTrack 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"trackpoints;Trackpoint;array(TCXTrackpoint)"];
...
- (id)init {
    if ((self = [super init])) {
        _trackpoints = [NSMutableArray new];    
    }
    return self;
}
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"trackpoints", self.trackpoints];
