...
#import "_TCXActivityLapExtensions.h"

#import "AXActivityLapExtension.h"


@implementation _TCXActivityLapExtensions 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"lX;LX;object(AXActivityLapExtension)"];
...
+ (NSDictionary *)fieldMappingNamespaces {
    ...
    [namespaces bmSafeSetObject:@"http://www.garmin.com/xmlschemas/ActivityExtension/v2" forKey:@"LX"];
    return namespaces;
}
