...
#import "_TCXHeartRate.h"

#import "TCXZone.h"


@implementation _TCXHeartRate 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"heartRateZone;HeartRateZone;object(TCXZone)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"heartRateZone", self.heartRateZone];
