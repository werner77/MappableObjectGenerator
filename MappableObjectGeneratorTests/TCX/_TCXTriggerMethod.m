...
#import "_TCXTriggerMethod.h"

#import "TCXToken.h"


@implementation _TCXTriggerMethod 
...
+ (void)initialize {
	if (!valueMapping) {
		...
		@"Manual", @(TCXTriggerMethodManual),
		@"Distance", @(TCXTriggerMethodDistance),
		@"Location", @(TCXTriggerMethodLocation),
		@"Time", @(TCXTriggerMethodTime),
		@"HeartRate", @(TCXTriggerMethodHeartrate),
...
- (TCXTriggerMethodValue) enumValue {
...
- (void)setEnumValue:(TCXTriggerMethodValue)theValue {
...
- (BOOL)isEqual:(id)other {
    ...
    _TCXTriggerMethod *otherValue = (_TCXTriggerMethod *)other;
...
+ (id)instanceWithEnumValue:(TCXTriggerMethodValue)theValue {
    _TCXTriggerMethod * instance = [[self alloc] init];
