...
#import "_TCXSensorState.h"

#import "TCXToken.h"


@implementation _TCXSensorState 
...
+ (void)initialize {
	if (!valueMapping) {
		...
		@"Present", @(TCXSensorStatePresent),
		@"Absent", @(TCXSensorStateAbsent),
...
- (void)setEnumValue:(TCXSensorStateValue)theValue {
...
- (BOOL)isEqual:(id)other {
    ...
    _TCXSensorState *otherValue = (_TCXSensorState *)other;
...
+ (id)instanceWithEnumValue:(TCXSensorStateValue)theValue {
    _TCXSensorState * instance = [[self alloc] init];
