...
#import "_TCXNameKeyReference.h"

#import "TCXRestrictedToken.h"


@implementation _TCXNameKeyReference 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"idObject;Id;object(TCXRestrictedToken)"];
...
- (NSString *)description {
    ...
    [s appendFormat:@", %@: %@", @"idObject", self.idObject];
