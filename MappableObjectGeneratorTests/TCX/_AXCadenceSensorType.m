...
#import "_AXCadenceSensorType.h"

#import "AXToken.h"


@implementation _AXCadenceSensorType 
...
+ (void)initialize {
	if (!valueMapping) {
		...
		@"Footpod", @(AXCadenceSensorTypeFootpod),
		@"Bike", @(AXCadenceSensorTypeBike),
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"value;;object(AXToken)"];
...
- (AXCadenceSensorTypeValue) enumValue {
...
- (void)setEnumValue:(AXCadenceSensorTypeValue)theValue {
...
- (BOOL)isEqual:(id)other {
    ...
    _AXCadenceSensorType *otherValue = (_AXCadenceSensorType *)other;
...
+ (id)instanceWithEnumValue:(AXCadenceSensorTypeValue)theValue {
    _AXCadenceSensorType * instance = [[self alloc] init];
