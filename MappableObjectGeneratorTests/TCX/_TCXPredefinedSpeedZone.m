...
#import "_TCXPredefinedSpeedZone.h"

#import "TCXSpeedZoneNumbers.h"


@implementation _TCXPredefinedSpeedZone 
...
+ (NSArray *)fieldMappingFormatArray {
    ...
    [mappings bmSafeAddObject:@"number;Number;object(TCXSpeedZoneNumbers)"];
