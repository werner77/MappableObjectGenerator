...
#import "_TCXSpeedType.h"

#import "TCXToken.h"


@implementation _TCXSpeedType 
...
+ (void)initialize {
	if (!valueMapping) {
		...
		@"Pace", @(TCXSpeedTypePace),
		@"Speed", @(TCXSpeedTypeSpeed),
...
- (void)setEnumValue:(TCXSpeedTypeValue)theValue {
...
- (BOOL)isEqual:(id)other {
    ...
    _TCXSpeedType *otherValue = (_TCXSpeedType *)other;
...
+ (id)instanceWithEnumValue:(TCXSpeedTypeValue)theValue {
    _TCXSpeedType * instance = [[self alloc] init];
